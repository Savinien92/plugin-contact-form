...
<form id="modFieldForm" action="../wp-content/plugins/plugin-contact-form/admin/traitement/update_fields.php" method="post">
    ...
    <table class="form-table">
        ...
        foreach( $results as $row ) {
            ...
            echo '<td><a href="../wp-content/plugins/plugin-contact-form/admin/traitement/delete_field.php?field_id=' . $id . '&fcn=' . $name . '">';
